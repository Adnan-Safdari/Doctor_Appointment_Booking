            ...
            <div class="row shadow-lg rounded-4 bg-white overflow-hidden">
                ...
                <div class="col-md-5 d-flex flex-column justify-content-center bg-light p-4">
                    ...
                    <ul class="list-unstyled mb-4">
                        <li class="mb-2"><i class="bi bi-check-circle-fill text-primary me-2"></i>Easy appointment booking with top doctors</li>
                        <li class="mb-2"><i class="bi bi-check-circle-fill text-primary me-2"></i>Access to medical history and records</li>
                        <li class="mb-2"><i class="bi bi-check-circle-fill text-primary me-2"></i>Reminder notifications for appointments</li>
                        <li class="mb-2"><i class="bi bi-check-circle-fill text-primary me-2"></i>24/7 customer support</li>
                    </ul>
                    <div class="border rounded p-3 bg-white">
                        <strong><i class="bi bi-shield-lock-fill text-primary me-2"></i>Secure & Private</strong>
